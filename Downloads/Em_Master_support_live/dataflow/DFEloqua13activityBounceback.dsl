...
source(output(
		body as (count as short, hasMore as boolean, items as (ActivityId as integer, ActivityType as string, AssetId as short, AssetName as string, AssetType as string, CRMCampaignId as string, CampaignId as short, CampaignName as string, ContactId as integer, CreatedAt as string, EmailAddress as string, EmailDeploymentId as integer, EmailRecipientId as string, ExternalId as string, SmtpErrorCode as string, SmtpMessage as string, SmtpStatusCode as short)[], limit as short, offset as boolean, totalResults as integer),
...
derivedColumn1 sink(allowSchemaDrift: true,
	validateSchema: false,
	partitionFileNames:[(concat('Activity13_Bounceback_P', $Item,'.json'))],
