...
source(output(
	...
	validateSchema: false,
	isolationLevel: 'READ_UNCOMMITTED',
	query: 'select MAX(CreatedAt) as maximumdate   FROM [ods].[Em_Activity]\nwhere Instance =\'EL06\' and ActivityType=\'EmailClickthrough\'',
	format: 'query',
	staged: true) ~> source2
source(output(
		maximumdate as string
	...
	validateSchema: false,
	isolationLevel: 'READ_UNCOMMITTED',
	query: 'select MAX(CreatedAt) as maximumdate   FROM [ods].[Em_Activity]\nwhere Instance =\'EL06\' and ActivityType=\'EmailOpen\'',
	format: 'query',
	staged: true) ~> source3
source(output(
		maximumdate as string
	...
	validateSchema: false,
	isolationLevel: 'READ_UNCOMMITTED',
	query: 'select MAX(CreatedAt) as maximumdate   FROM [ods].[Em_Activity]\nwhere Instance =\'EL06\' and ActivityType=\'EmailSend\'',
	format: 'query',
	staged: true) ~> source4
source(output(
		maximumdate as string
	...
	validateSchema: false,
	isolationLevel: 'READ_UNCOMMITTED',
	query: 'select MAX(CreatedAt) as maximumdate   FROM [ods].[Em_Activity]\nwhere Instance =\'EL06\' and ActivityType=\'FormSubmit\'',
	format: 'query',
	staged: true) ~> source5
source(output(
		maximumdate as string
	...
	validateSchema: false,
	isolationLevel: 'READ_UNCOMMITTED',
	query: 'select MAX(CreatedAt) as maximumdate   FROM [ods].[Em_Activity]\nwhere Instance =\'EL06\' and ActivityType=\'PageView\'',
	format: 'query',
	staged: true) ~> source6
source(output(
		maximumdate as string
	...
	validateSchema: false,
	isolationLevel: 'READ_UNCOMMITTED',
	query: 'select MAX(CreatedAt) as maximumdate   FROM [ods].[Em_Activity]\nwhere Instance =\'EL06\' and ActivityType=\'Subscribe\'',
	format: 'query',
	staged: true) ~> source7
source(output(
		maximumdate as string
	...
	validateSchema: false,
	isolationLevel: 'READ_UNCOMMITTED',
	query: 'select MAX(CreatedAt) as maximumdate   FROM [ods].[Em_Activity]\nwhere Instance =\'EL06\' and ActivityType=\'Unsubscribe\'',
	format: 'query',
	staged: true) ~> source8
source(output(
		maximumdate as string
	...
	validateSchema: false,
	isolationLevel: 'READ_UNCOMMITTED',
	query: 'select MAX(CreatedAt) as maximumdate   FROM [ods].[Em_Activity]\nwhere Instance =\'EL06\' and ActivityType=\'WebVisit\'',
	format: 'query',
	staged: true) ~> source9
