...
select1 derive(Reg_Date = iif (right(Reg_Date, 2)=='PM',toTimestamp(replace(replace(Reg_Date,'PM',''),'AM',''), 'dd/MM/yyyy HH:mm:ss')+hours(12), iif( instr(toString(Reg_Date),'Z') == 0,toTimestamp(replace(replace(Reg_Date,'PM',''),'AM',''), 'dd/MM/yyyy HH:mm:ss'),
