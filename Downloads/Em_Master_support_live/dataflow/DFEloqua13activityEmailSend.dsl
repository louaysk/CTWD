...
source(output(
		body as (count as short, hasMore as boolean, items as (ActivityId as integer, ActivityType as string, AssetId as short, AssetName as string, AssetType as string, CRMCampaignId as string, CampaignId as short, CampaignName as string, CampaignResponseCreatedAt as string, ContactId as integer, CreatedAt as string, EmailAddress as string, EmailDeploymentId as integer, EmailRecipientId as string, EmailSendType as string, EmailWebLink as string, ExternalId as string, MemberStatus as string, SubjectLine as string)[], limit as short, offset as boolean, totalResults as integer),
...
derivedColumn1 sink(allowSchemaDrift: true,
	validateSchema: false,
	partitionFileNames:[(concat('Activity_EmailSend_P', $Item,'.json'))],
