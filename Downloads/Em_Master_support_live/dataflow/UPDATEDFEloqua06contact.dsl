...
source(output(
		body as (count as short, hasMore as boolean, items as (C_Address1 as string, C_Address2 as string, C_Address3 as string, C_Age_Group1 as string, C_Annual_Revenue1 as string, C_BusPhone as string, C_City as string, C_Company as string, C_Company_Revenue1 as string, C_Company_Size1 as string, C_Company_Website1 as string, C_Country as string, C_DateCreated as string, C_DateModified as string, C_Designation1 as string, C_Designation_Level1 as string, C_ElqPURLName as string, C_EmailAddressDomain as string, C_EmailDisplayName as string, C_Fax as string, C_Field_Merge___Personalization1 as string, C_FirstAndLastName as string, C_FirstName as string, C_Full_Name1 as string, C_Gender1 as string, C_IND_ID1 as string, C_Industry1 as string, C_Integrated_Marketing_and_Sales_Funnel_Stage as string, C_Job_Function1 as string, C_Job_Role1 as string, C_LS___High_Value_Website_Content1 as string, C_LastMSCRMCampaignResponseID as string, C_LastModifiedByExtIntegrateSystem as string, C_LastName as string, C_Lead_Rating___Combined1 as string, C_Lead_Rating___Explicit1 as string, C_Lead_Rating___Implicit1 as string, C_Lead_Score_Date___Most_Recent1 as string, C_Lead_Score_Date___Profile___Most_Recent1 as string, C_Lead_Score___Explicit1 as string, C_Lead_Score___Implicit1 as string, C_Lead_Score___Last_High_Touch_Event_Date1 as string, C_Lead_Source___Most_Recent1 as string, C_Lead_Source___Original1 as string, C_Lead_Status1 as string, C_MD5HashedBusPhone as string, C_MD5HashedEmailAddress as string, C_MD5HashedMobilePhone as string, C_MSCRMAccountID as string, C_MSCRMContactID as string, C_MSCRMLastCampaignID as string, C_MSCRMLastCampaignName as string, C_MSCRMLastCampaignStatus as string, C_MSCRMLeadID as string, C_MSCRM_EmailOptOut as string, C_MSCRM_LeadRating as boolean, C_Middle_Name1 as string, C_MobilePhone as string, C_Nationality1 as string, C_Personalized_Link1 as string, C_Product_Solution_of_Interest1 as string, C_Promo_Code1 as string, C_Region1 as string, C_SFDCAccountID as string, C_SFDCContactID as string, C_SFDCLastCampaignID as string, C_SFDCLastCampaignStatus as string, C_SFDCLeadID as string, C_SFDC_EmailOptOut1 as string, C_SHA256HashedBusPhone as string, C_SHA256HashedEmailAddress as string, C_SHA256HashedMobilePhone as string, C_Salesperson as string, C_Salutation as string, C_Social_Profile___Facebook1 as string, C_Social_Profile___LinkedIn1 as string, C_Social_Profile___Twitter1 as string, C_Social_Profile___Xing1 as string, C_State_Prov as string, C_Territory as string, C_Title as string, C_Zip_Postal as short, C_elqPURLName1 as string, ContactIDExt as string, Contact_Id as integer, EmailAddress as string, EmailFormat as string, IsBounced as boolean, IsSubscribed as boolean)[], limit as short, offset as boolean, totalResults as short),
...
source1 foldDown(unroll(body.items),
	mapColumn(
		...
		C_Full_Name1 = body.items.C_Full_Name1,
		...
		C_Personalized_Link1 = body.items.C_Personalized_Link1,
		C_Product_Solution_of_Interest1 = body.items.C_Product_Solution_of_Interest1,
		C_Promo_Code1 = body.items.C_Promo_Code1,
		...
		C_Social_Profile___Facebook1 = body.items.C_Social_Profile___Facebook1,
		C_Social_Profile___LinkedIn1 = body.items.C_Social_Profile___LinkedIn1,
		C_Social_Profile___Twitter1 = body.items.C_Social_Profile___Twitter1,
		C_Social_Profile___Xing1 = body.items.C_Social_Profile___Xing1,
...
flatten1 sink(allowSchemaDrift: true,
	validateSchema: false,
	partitionFileNames:[(concat('UPDATEContactEloqua06_',toString(currentDate()),toString(currentUTC())))],
	umask: 0022,
	preCommands: [],
	postCommands: [],
